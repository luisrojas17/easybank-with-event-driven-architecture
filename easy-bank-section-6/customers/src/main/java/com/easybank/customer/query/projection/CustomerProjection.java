 ...
 * <br/>
 * This component throws the process to update data in the reading database.
 *
 */
@Slf4j
@Component
...
public class CustomerProjection {
    ...
    // To handle the event published by the aggregate (CustomerAggregate)
    @EventHandler
    public void on(CustomerMobileNumberUpdatedEvent customerMobileNumberUpdatedEvent) {

        log.info("Processing CustomerMobileNumberUpdatedEvent.\n\t[{}]",
